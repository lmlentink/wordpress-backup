		...
		<div class="nav-holder">
			<div class="container">
    			...
    			<div id="toggle-button">
    				<span></span><?php esc_html_e( 'Menu', 'blossom-fashion' ); ?>
    			</div>
            						...
            						<div class="img-holder">
                                        ...
                                        <?php 
                                            if( has_post_thumbnail() ){
                                                ...
                                                <img src="<?php echo esc_url( get_template_directory_uri() . '/images/no-img_400_230.jpg' ); ?>" alt="<?php the_title_attribute(); ?>" />;
                                            <?php
                                            }
                                        ?>
                                        </a>
                                    ...
                                    <a href="<?php the_permalink(); ?>" rel="bookmark">
                                        <?php 
                                            if( has_post_thumbnail() ){
                                                ...
                                                <img src="<?php echo esc_url( get_template_directory_uri() . '/images/no-img_293_400.jpg' ); ?>" alt="<?php the_title_attribute(); ?>" />;
                                            <?php
                                            }                                                                                      
                                        ?>
                                    </a>
...
function blossom_fashion_content_start(){ 
    ...
    */                                                        
    if( ( is_archive() && ! is_author() ) || is_page() ){ ?>
...
function blossom_fashion_entry_header(){ ?>
    <header class="entry-header">
		<?php 
            ...
            if( is_single() ){
                if( ! $ed_cat_single ) blossom_fashion_category();
            }else{
                blossom_fashion_category();    
            }
            ...
            if( 'post' === get_post_type() ){
                ...
                if( is_single() ){
                    if( ! $ed_post_date ) blossom_fashion_posted_on();
                }else{
        				...
        				<a href="<?php the_permalink(); ?>" class="post-thumbnail">
                            <?php
                                if( has_post_thumbnail() ){
                                    ...
                                    <img src="<?php echo esc_url( get_template_directory_uri() . '/images/no-img_280_215.jpg' ); ?>" alt="<?php the_title_attribute(); ?>" />
                                <?php 
                                }
                            ?>
                        </a>
...
function blossom_fashion_instagram_section(){ 
    if( is_front_page() && blossom_fashion_is_btif_activated() ){
        ...
        if( $ed_instagram ){
            ...
            echo '<a href="' . esc_url( $instaUrl ) . '" target="_blank" rel="nofollow">' . esc_html__( 'Follow @ Instagram', 'blossom-fashion' ) . '</a>';
            echo '</h2></section>';
    ...
    <div class="footer-b">
		<div class="container">
            ...
            <?php
                ...
                echo '<a href="' . esc_url( 'https://blossomthemes.com/themes/blossom-fashion-free-wordpress-theme' ) .'" rel="author" target="_blank">' . esc_html__( ' Blossom Fashion', 'blossom-fashion' ) . '</a>' . esc_html__( ' by Blossom Themes.', 'blossom-fashion' );                                
